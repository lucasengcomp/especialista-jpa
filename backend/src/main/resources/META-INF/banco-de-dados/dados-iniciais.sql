...
insert into cliente (id, nome, cpf) values (1, 'Fernando Medeiros', '000.111.222-33');
insert into cliente (id, nome, cpf) values (2, 'Marcos Mariano', '111.222.333-44');
insert into cliente (id, nome, cpf) values (10, 'Nishi Nakamura', '222.333.444-55');
...
insert into produto_categoria (produto_id, categoria_id) values (1, 2);z