...
public class ExportarDDL {
    ...
    public static void main(String[] args) {
        ...
        propriedades.put("javax.persistence.schema-generation.scripts.create-target",
                "C:/Users/lucas/Documents/especialista-jpa/arquivo-exportado//script-criacao-exportado.sql");
        propriedades.put("javax.persistence.schema-generation.scripts.drop-target",
                "C:/Users/lucas/Documents/especialista-jpa/arquivo-exportado/script-remocao-exportado.sql");
